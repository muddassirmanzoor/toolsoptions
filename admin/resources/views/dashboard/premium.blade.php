            ...
            <div class="col-lg-7 premium-left">
                <div class="premium-content">
                    ...
                    <div class="payment-methods-premium">
                        <div class="payment-method-item active" data-method="card" style="display: none !important;">
                    ...
                    <form id="premiumForm" class="premium-form" style="display: none !important;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Stripe Elements init skipped when card is hidden
