...
def convert_jpgs_to_pdf(output_pdf, *image_files):
    try:
        images = []
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python convert_jpgs_to_pdf.py <output_pdf> <image_file1> <image_file2> ...")
        sys.exit(1)
    ...
    convert_jpgs_to_pdf(output_pdf, *image_files)
