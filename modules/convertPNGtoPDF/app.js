document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateUIState() {
        if (pngFiles.length > 0) {
            ...
            if (fileCountBadge) {
                fileCountBadge.textContent = pngFiles.length;
    ...
    if (selectFilesBtn) {
        selectFilesBtn.addEventListener("click", () => pngInput.click());
    }
    ...
    if (addBtn) {
        addBtn.addEventListener("click", () => pngInput.click());
    }

    if (computerBtn) {
        computerBtn.addEventListener("click", () => pngInput.click());
    }
