    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="modal-body" style="padding: 30px;">
                ...
                <!-- Payment Methods (Stripe/card hidden for now) -->
                <div class="payment-methods-modal">
                    <div class="payment-method-item-modal" data-method="card" style="display: none !important;">
                ...
                <!-- Card Details Form with Stripe Elements (hidden for now) -->
                <div class="card-details-section" id="cardDetailsSectionTeam" style="display: none !important;">
                ...
                <!-- PayPal Button -->
                <div id="paypalButtonContainerModalTeam" class="paypal-button-container-modal">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (inviteMembersBtn) {
        inviteMembersBtn.addEventListener('click', function() {
            upgradeModal.show();
            // Stripe/card hidden for now - no init
        });
    }
    ...
    // Set initial state - PayPal only (Stripe/card hidden for now)
    if (paypalButtonContainerModalTeam) {
        paypalButtonContainerModalTeam.style.display = 'block';
    }
    if (cardDetailsSectionTeam) {
        cardDetailsSectionTeam.style.display = 'none';
    }
    if (confirmPaymentBtnTeam) {
        confirmPaymentBtnTeam.style.display = 'none';
    }
